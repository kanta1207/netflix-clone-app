...
export const requestMovieDetails = (movieId) => `https://api.themoviedb.org/3/movie/${movieId}?api_key=<<api_key>>&language=en-US` 

export const requestSimillarMovies  = (movieId) => `https://api.themoviedb.org/3/movie/${movieId}/similar?api_key=<<api_key>>&language=en-US&page=1`